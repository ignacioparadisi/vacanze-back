    ...
    public class  FlightResConnection 
    {
        ...
        public int AddReservationFlight(Entity entity){
            ...
            try{
                ...
                resflight._idres=Convert.ToInt32(table.Rows[0][0].ToString());

                if(resflight._idres.Equals(0)){

                    throw new EmptyReservationException("Disculpe la reserva no se agrego");
        ...
        public List<FlightRes> GetReservationFlight(int id){
            var FlightRes = new List<FlightRes>();
            var table = new DataTable();
        ...
        public List<ListRes> GetFlightValidateI(int id_city_i,int id_city_v,string date_i,int numpas){
            int cont=0;
