...
CREATE TABLE CLAIM(
  ...
  CLA_STATUS VARCHAR CHECK (CLA_STATUS = 'OPEN' OR CLA_STATUS = 'CLOSE') NOT NULL,
  CONSTRAINT PRIMARY_CLAIM PRIMARY KEY (CLA_ID)
);

CREATE TABLE BAGGAGE(
  BAG_ID SERIAL,
  BAG_STATUS VARCHAR CHECK (BAG_STATUS = 'LOST' OR BAG_STATUS = 'ACTIVE' OR BAG_STATUS = 'RECLAIMED' OR BAG_STATUS = 'FOUND') NOT NULL,
  BAG_DESCR VARCHAR,
