...
CREATE TABLE CABIN(
  ...
  CONSTRAINT FOREIGN_CAB_CRU FOREIGN KEY (CAB_CRU_FK) REFERENCES CRUISE(CRU_ID) ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE TABLEREST(
  ...
  CONSTRAINT FOREIGN_RES FOREIGN KEY (TAB_RES_FK) REFERENCES RESTAURANT(RES_ID) ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE RES_REST(
  ...
  CONSTRAINT FOREIGN_TABLEREST FOREIGN KEY (RR_TABLEREST_FK) REFERENCES TABLEREST(TAB_ID) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE ROOM(
  ...
  CONSTRAINT PRIMARY_ROOM PRIMARY KEY (ROO_ID),
  CONSTRAINT FOREIGN_HOTEL FOREIGN KEY (ROO_HOT_FK) REFERENCES HOTEL(HOT_ID) ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE RES_ROO(
  ...
  RR_USE_FK INTEGER NOT NULL,
  RR_ROO_FK INTEGER NOT NULL,
  RR_PAY_FK INTEGER NOT NULL,
  ...
  CONSTRAINT FOREIGN_ROOM FOREIGN KEY (RR_ROO_FK) REFERENCES ROOM(ROO_ID) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE RES_FLI(
  ...
  RF_STATUS BOOLEAN DEFAULT TRUE NOT NULL,
...
CREATE TABLE STOP(
  ...
  STO_DEPARTUREDATE TIMESTAMP NOT NULL,
  STO_ARRIVALDATE TIMESTAMP NOT NULL,
  STO_LOC_DEPARTURE INTEGER NOT NULL,
  STO_LOC_ARRIVAL INTEGER NOT NULL,
  STO_CRU_FK INTEGER,
  STO_FLI_FK INTEGER,
  CONSTRAINT PRIMARY_STOP PRIMARY KEY (STO_ID),
  CONSTRAINT FOREIGN_STO_FLIGHT FOREIGN KEY (STO_FLI_FK) REFERENCES FLIGHT(FLI_ID) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT FOREIGN_STO_CRU FOREIGN KEY (STO_CRU_FK) REFERENCES CRUISE(CRU_ID) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT FOREIGN_LOC_ARRIVAL FOREIGN KEY (STO_LOC_ARRIVAL) REFERENCES LOCATION(LOC_ID) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT FOREIGN_LOC_DEPARTURE FOREIGN KEY (STO_LOC_DEPARTURE) REFERENCES LOCATION(LOC_ID) ON DELETE CASCADE ON UPDATE CASCADE
);
